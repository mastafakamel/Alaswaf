/**
 * Date conversion utilities for Admin Panel
 * Converts between Hijri and Gregorian calendars
 */
...
export function toGregorian(hijriYear, hijriMonth, hijriDay) {
...
// Format Hijri date components for input (return as separate values)
export function getHijriComponents(date) {
